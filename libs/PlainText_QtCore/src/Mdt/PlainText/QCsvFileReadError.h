...
namespace Mdt{ namespace PlainText{
  ...
  /*! \brief Error thrown when reading a CSV file failed
   */
  class MDT_PLAINTEXT_QTCORE_EXPORT QCsvFileReadError : public QRuntimeError
  {
   public:

    /*! \brief Construct a error
     */
    explicit QCsvFileReadError(const QString & what)
     : QRuntimeError(what)
    {
    }
  };
